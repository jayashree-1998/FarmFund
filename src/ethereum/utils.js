...
const CROP_FACTORY_ADDRESS = '0x89170BD45d6662DEe1FE9c29480Bc5028135c5fc'
...
// DO NOT REPEAT initWeb3 calls in each component
export async function initWeb3() {
    ...
    console.log(`Crop Factory (${CROP_FACTORY_ADDRESS})`)
}
...
export async function getContractAddressesForFarmer(farmerAddress) {
    ...
    if (!farmerAddress)
        ...
        return getCropFactoryContract().methods.getContractsForFarmerAtAddress(farmerAddress).call({ from: defaultAccount })
}
...
export async function getGovtContractForFarmer(farmerAddress) {
    return new web3Instance.eth.Contract(GovtABI, (await getContractAddressesForFarmer(farmerAddress)).govrep)
}
